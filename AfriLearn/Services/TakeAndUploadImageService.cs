...
{
    class TakeAndUploadImageService : BaseViewModel
    {
        // fields
        ...
        public TakeAndUploadImageService()
        {
        ...
        public async  Task TakeAndUploadImage( )
        {
            ...
            {
                await DisplayAlert("Not supported", "Your device does not currently support" +
                    " this functionality", "Ok");
                return;
            }
