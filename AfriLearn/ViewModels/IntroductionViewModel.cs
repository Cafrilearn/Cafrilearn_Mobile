...
namespace AfriLearnMobile.ViewModels
{
    ...
    {
        public ICommand NavigateToIntroPageTwoCommand => new Command(() => NavigationService.PushAsync(new IntroPageTwo()));
        public ICommand NavigateToIntroPageThreeCommand => new Command(() => NavigationService.PushAsync(new  IntroPageThree()));
