    ...
    public class ChatViewModel : VM.BaseViewModel
    {
        ...
        public ChatViewModel()
        {
            ...
            _connection = new HubConnectionBuilder()
                   .WithUrl(AppConstants.ChatUri + "AfriLearnMessage")
                   .Build();
            _connection.On<Message>("AfriLearnMessage", (message) =>
            {
        ...
        public ICommand SendMessageCommand => new Command(async () =>
        {
            ...
            await _connection.InvokeAsync("AfriLearnMessage", afrilearnText);
